# Linear search in a skip list mandatory
...
```
ubuntu@~/0x0E-linear_skip$ cat 0-main.c 
#include <stdio.h>
#include <stdlib.h>
...
ubuntu@~/0x0E-linear_skip$ gcc -Wall -Wextra -Werror -pedantic 0-main.c 0-linear_skip.c skiplist/*.c -lm -o 0-linear_skip
ubuntu@~/0x0E-linear_skip$ ./0-linear_skip
List :
Index[0] = [0]
Index[1] = [1]
Index[2] = [2]
