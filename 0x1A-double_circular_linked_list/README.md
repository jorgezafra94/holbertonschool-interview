...
Create the source file 0-add_node.c that contains the following functions:<br>
<br>
...
```
ubuntu:0x1A-double_circular_linked_list$ cat 0-main.c 
#include <stdio.h>
#include <stdlib.h>
#include "list.h"
...
ubuntu:0x1A-double_circular_linked_list$ gcc -Wall -Wextra -Werror -pedantic 0-main.c 0-add_node.c
ubuntu:0x1A-double_circular_linked_list$ ./a.out 
Holberton
        ->prev: Engineer
        ->next: School
School
...
Holberton
        ->prev: School
        ->next: Engineer
ubuntu:0x1A-double_circular_linked_list$ 
```
