...
```
ubuntu@0x12-search_algorithms$ cat 0-main.c 
#include <stdio.h>
#include <stdlib.h>
...
ubuntu@0x12-search_algorithms$ gcc -Wall -Wextra -Werror -pedantic 0-main.c 0-advanced_binary.c -o 0-advanced_binary
ubuntu@0x12-search_algorithms$ ./0-advanced_binary
